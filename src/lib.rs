...
//!
//! RefPack is a nonstandardized format that varied greatly in exact encoding
//! and implementation. `refpack` uses a `Format` system to specify different
//! encoding formats. This is implemented via generic trait parameters that get
//! monomorphized down to static dispatch.
//!
...
//! should be a unit or "unconstructable" (one inaccessible `()` member to
//! prevent construction), and define a pair of how to interpret
//!
//!
//! ## Implementations
//!
...
//! |--------|-------|---------|--------|
//! | [Reference](crate::format::Reference) | Various 90s Origin Software and EA
//! games | [Reference](crate::data::control::mode::Reference) |
//! [Reference](crate::header::mode::Reference) |
//! | [TheSims12](crate::format::TheSims12) | The Sims, The Sims Online, The
//! Sims 2 | [Reference](crate::data::control::mode::Reference) |
//! [Maxis](crate::header::mode::Maxis) | | [Simcity4](crate::format::Simcity4)
//! | Simcity 4 | [Simcity4](crate::data::control::mode::Simcity4) |
//! [Maxis](crate::header::mode::Maxis) |
//! | [TheSims34](crate::format::TheSims34) | The Sims 3, The Sims 4 |
